...
class ListPage extends Component {
        ...
        <div className="container ListPage py-4">
          <div className="row justify-content-center">
            <div className="col-md-8">
              <header className={"mb-4 "+ styles.white}>
                ...
                {Object.keys(config.ROMS)
                  ...
                  .map(key => (
                    ...
                    <Link
                      action
                      key={key}
                      to={"/jsnes/run/" + encodeURIComponent(key)}
              ...
              {this.state.romLibrary.length > 0 ? (
                <div>
                  <p className={styles.white}>Previously played:</p>
  ...
  handleDrop = e => {
    ...
    RomLibrary.save(file).then(rom => {
      this.updateLibrary();
      this.props.history.push({ pathname: "jsnes/run/local-" + rom.hash });
    });
  };
}
